...
<pre>&lt;script&gt;twemoji.parse(document.getElementById('emojiTest'), {size: 72});&lt;/script&gt;</pre><div>
    <div id="emojiTest">Test render : <span>J'ai mangé chinois 😱😍🍱🍣🍥🍙🍘🍚🍜🍱🍣🍥🍙🍘🍚🍜</span></div>
    <script>twemoji.parse(document.getElementById('emojiTest'), { size: 72 });</script> </div>
    </form>
</body>
</html>
